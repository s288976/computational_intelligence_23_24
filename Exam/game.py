...
class Game(object):
    ...
    def play_trajectory(self, player1: Player, player2: Player) -> int:
        ...
        while winner < 0:
            ...
            state = (board, from_pos, slide, self.current_player_idx)
    ...
    def move (self, col, row, move, player):
        return self.__move((col, row), move, player)
